...
public class ProductStepDefs {
    ...
    @And("Account Officer fills in the application data with disbursement outlet {string}, application purpose {string},  loan purpose {string}, rubric {string}, loan amount {string}, and product {string}")
    ...
    @And("Account Officer fills in the customer data with customer id {string}, customer name {string}, gender {string}, PlaceOfBirth {string}, PinCode {string}, SubDistrict {string} and verify from Dukcapil")
    ...
    @And("Account Officer adds One Collateral with Collateral Category {string}, Collateral Type {string}, Collateral Condition {string}")
    ...
    @When("Account Officer clicks submit for product {string}")
